...
public class GitApp {
    ...
    //远程仓库地址
    public static final String REMOTEREPOURI = "http://192.168.8.6/hundsun.git";

    //操作git:账号、密码
    public static final String USER = "yuanyixiong";
    public static final String PASSWORD = "yuanyixiong";
